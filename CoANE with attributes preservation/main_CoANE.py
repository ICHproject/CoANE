...
def parse_args():
    ...
    parser.add_argument('--contoller', type=float, default=1e-3, help='Hyperparameter of negative sampling')
    parser.add_argument('--c_f', type=float, default=1e5, help='Hyperparameter of attribute preservation')
    parser.add_argument('--decay', type=float, default=0, help='Learning decay')
